...
## Project Structure
    ...
    ├── testapiautoconnect_118957  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_118957`
...
2. Clone this repo and `cd testapiautoconnect_118957`
